...
const PRODUCTS = [
  ...
  },
  {
    ...
    links: {
      download: {
        macos: 'https://github.com/srikanthpullela/hush-app/releases/latest/download/Hush_1.0.5_aarch64.dmg',
        windows: 'https://github.com/srikanthpullela/hush-app/releases/latest/download/Hush_1.0.5_x64-setup.exe',
      },
    },
  },
];
